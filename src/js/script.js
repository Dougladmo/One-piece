...
luffy.addEventListener('click', function() {
    ...
    html.classList.remove('zoro')
    html.classList.remove('nami')
    html.classList.remove('chopper')
    html.classList.remove('sanji')
})
...
zoro.addEventListener('click', function() {
    ...
    html.classList.remove('luffy')
    html.classList.remove('nami')
    html.classList.remove('chopper')
    html.classList.remove('sanji')
    html.classList.add('zoro')
})
